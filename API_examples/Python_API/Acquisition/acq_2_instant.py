...
print("Trigger mode:        INSTANT (RP_TRIG_SRC_NOW)")
...
time.sleep(0.1)  # Short delay to ensure pre-trigger samples are captured
...
res = rp.rp_AcqGetDataVNP(channel, trig_pos, data_ch_V)
