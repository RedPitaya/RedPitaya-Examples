...
Important Note:
    Slow analog outputs can generate voltages from 0V to 1.8V only and are intended for low-frequency applications.
    Voltage resolution: approximately 0.007V (1.8V / 256)
    Output impedance: ~100Ω (100Ω series + 8.2nF shunt low-pass filter)
