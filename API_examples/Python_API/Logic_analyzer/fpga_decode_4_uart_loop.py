...
buff_uart = np.array(data_int, dtype=np.uint8)  # Create NumPy array for transmit buffer
...
rp_cla.setDecoderSettingsString("UART", "bitOrder", dec_bit_order)
rp_cla.setDecoderSettingsString("UART", "invert", dec_invert)
rp_cla.setDecoderSettingsString("UART", "num_data_bits", dec_num_data_bits)
rp_cla.setDecoderSettingsString("UART", "num_stop_bits", dec_num_stop_bits)
rp_cla.setDecoderSettingsString("UART", "parity", dec_parity)
rp_cla.setDecoderSettingsString("UART", "rx", dec_rx)
rp_cla.setDecoderSettingsString("UART", "tx", dec_tx)
