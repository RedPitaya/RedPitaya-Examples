...
num_stop_bits = "Stop_Bit_20"           # Stop bits: "Stop_Bit_No", "Stop_Bit_05", "Stop_Bit_10", "Stop_Bit_15", "Stop_Bit_20"
parity = "Odd"                         # Parity: "None", "Even", "Odd", "Always_0", "Always_1"
...
trigger_ch = rp_la.LA_T_CHANNEL_1       # Trigger on channel 1 (RX)
...
rp_cla.setDecoderSettingsString("UART", "bitOrder", bit_order)
rp_cla.setDecoderSettingsString("UART", "invert", invert)
rp_cla.setDecoderSettingsString("UART", "num_data_bits", num_data_bits)
rp_cla.setDecoderSettingsString("UART", "num_stop_bits", num_stop_bits)
rp_cla.setDecoderSettingsString("UART", "parity", parity)
rp_cla.setDecoderSettingsString("UART", "rx", rx_line)
rp_cla.setDecoderSettingsString("UART", "tx", tx_line)
