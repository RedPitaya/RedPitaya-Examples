...
trigger_ch = rp_la.LA_T_CHANNEL_1       # Trigger on channel 1 (SCLK)
...
tx_buff = np.array(data_int, dtype=np.uint8)  # Create NumPy array for transmit buffer
...
#                           message number, tx_buffer, init_rx_buff, toggle cs
rp_hw.rp_SPI_SetBufferForMessage(        0,  tx_buff,         True,     False)
...
rp_cla.setDecoderSettingsString("SPI", "bit_order", dec_bit_order)
rp_cla.setDecoderSettingsUInt("SPI", "cpha", dec_cpha)
rp_cla.setDecoderSettingsUInt("SPI", "cpol", dec_cpol)
rp_cla.setDecoderSettingsString("SPI", "invert_bit", dec_invert_bit)
rp_cla.setDecoderSettingsUInt("SPI", "word_size", dec_word_size)
rp_cla.setDecoderSettingsString("SPI", "cs_polarity", dec_cs_polarity)
rp_cla.setDecoderSettingsString("SPI", "cs", dec_cs)
rp_cla.setDecoderSettingsString("SPI", "clk", dec_clk)
rp_cla.setDecoderSettingsString("SPI", "miso", dec_miso)
rp_cla.setDecoderSettingsString("SPI", "mosi", dec_mosi)
