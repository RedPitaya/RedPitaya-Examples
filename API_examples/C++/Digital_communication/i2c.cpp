/* @brief This is a simple application for testing IIC communication on a
 * RedPitaya
...
int main(int argc, char *argv[]) {
  ...
  char data[] =
      "THIS IS A TEST MESSAGE FOR THE I2C PROTOCOL COMMUNICATION WITH A "
      "EEPROM. IT WAS WRITTEN FOR A REDPITAYA MEASURMENT TOOL.";
