...
inputs (AI0-AI3). These inputs can measure voltages in the range of 0-3.3V and
...
- Optional: Analog voltage sources (0-3.3V) connected to AI0-AI3 pins
...
Important Note:
    Slow analog inputs accept voltages from 0V to 3.3V only.
...
print(f"Voltage range:       0 to 3.3V")
print(f"Input impedance:     100 kΩ")
print()
print("WARNING: Do not exceed 3.3V on any analog input!")
print("=" * 70)
