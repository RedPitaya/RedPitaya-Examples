...
Ported to Python - Using rp_AcqGetOldestDataVNP
"""
...
def main():
    ...
    rp.rp_GenReset()
    rp.rp_GenFreq(rp.RP_CH_1, 1000.0)      # 1 kHz frequency
    ...
    rp.rp_AcqReset()
    rp.rp_AcqSetDecimation(rp.RP_DEC_1024)  # Decimation factor
    ...
    for step in range(1, count + 1):
        ...
        # In C code they wait 5 seconds with pre-trigger counter check
