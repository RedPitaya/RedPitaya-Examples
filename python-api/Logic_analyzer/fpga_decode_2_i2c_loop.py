...
trigger_ch = rp_la.LA_T_CHANNEL_8       # Trigger on channel 8 (SCL)
...
buff_addr[0] = offset >> 8              # High byte of address
buff_addr[1] = offset & 0xFF            # Low byte of address

# Create buffer for I2C read data
buff_i2c = rp_hw.Buffer(page_size)
