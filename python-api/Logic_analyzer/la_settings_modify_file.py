...
settings_uart["num_stop_bits"] = "Stop_Bit_No"  # Stop bits: Stop_Bit_No/0.5/1/1.5/2
...
print(f"  Parity:        {['None', 'Even', 'Odd', 'Mark', 'Space'][settings_uart['parity']]}")
print(f"  RX pin:        DIO{settings_uart['rx']}_P" if settings_uart['rx'] else "  RX pin:        Disabled")
...
print(f"  SCLK pin:      DIO{settings_spi['clk']}_P")
...
print(f"  Addr format:   {'Shifted' if settings_i2c['address_format'] == 0 else 'Unshifted'}")
print(f"  SCL pin:       DIO{settings_i2c['scl']}_P")
print(f"  SDA pin:       DIO{settings_i2c['sda']}_P")
