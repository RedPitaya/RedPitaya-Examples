...
burst_period = 500000           # Time between burst starts in microseconds (500 ms)
...
print(f"OUT1 Waveform: Rectified sine |sin(t)|")
print(f"  Samples: {resolution:,}, Range: [{wave_ch1.min():.3f}, {wave_ch1.max():.3f}]")
print(f"OUT2 Waveform: Modified sine |sin(t) + 0.5| clamped")
