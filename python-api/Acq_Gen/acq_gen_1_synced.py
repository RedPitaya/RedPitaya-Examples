...
#   RP_TRIG_SRC_CHD_PE, RP_TRIG_SRC_CHD_NE
...
# Check trigger state
trigger_state = rp.rp_AcqGetTriggerState()
...
fill_state = rp.rp_AcqGetBufferFillState()
...
res = rp.rp_AcqGetDataVNP(rp.RP_CH_1, 0, buffer_size, data_ch1)
