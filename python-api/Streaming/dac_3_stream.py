#!/usr/bin/python3
"""
Red Pitaya DAC Streaming Example - Direct Memory Mode

This example demonstrates how to stream waveform data from memory directly to Red Pitaya DACs.
Instead of using WAV files, this method loads data directly into FPGA memory buffers
for both channels, which can be more efficient for real-time applications.
"""
...
obj.setMemory16Bit(1, waveform_data)  # Load data to channel 1 memory
obj.setMemory16Bit(2, waveform_data)  # Load data to channel 2 memory
print("Waveform loaded to both DAC channels")

# Step 5: Start streaming from memory
print("\nStarting DAC streaming from memory...")
if not obj.startStreamingFromMemory():
